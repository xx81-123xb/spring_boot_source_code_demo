    ...
    public ApplicationEventMulticaster applicationEventMulticaster(ConfigurableApplicationContext context, ThreadPoolTaskExecutor executor) {
        return new AbstractApplicationEventMulticaster() {
            ...
            public void addApplicationListenerBean(String name) {
                ...
                // 获取该监听器支持的事件类型
//                System.out.println("==============================");
                Type before_type = listener.getClass().getGenericInterfaces()[0];
                if (before_type instanceof ParameterizedType) {
                    ParameterizedType trueType = (ParameterizedType) before_type;
                    Class<?> clazz= (Class<?>) trueType.getActualTypeArguments()[0];
                    System.out.println("===============================");
