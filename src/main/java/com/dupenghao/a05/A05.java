package com.dupenghao.a05;

import com.dupenghao.a05.mapper.Mapper1;
import com.dupenghao.a05.mapper.Mapper2;
...
//        context.registerBean(MapperPostProcessor.class); // 解析 Mapper 接口
        ...
        MetadataReader reader = factory.getMetadataReader(new ClassPathResource("com/dupenghao/a05/Config.class"));
