...
//        test7(context);
    ...
    private static void my_Test1(AnnotationConfigApplicationContext context) throws Exception {
        ...
        if (composite.supportsReturnType(returnType)) {//检查是否支持此类型的返回值

            composite.handleReturnValue(returnValue, returnType, modelAndViewContainer, webRequest);
            System.out.println(modelAndViewContainer.getModel());
            System.out.println(modelAndViewContainer.getViewName());

            renderView(context, modelAndViewContainer, webRequest);//渲染视图

        }
    }

    private static void my_Test2(AnnotationConfigApplicationContext context) throws Exception {
    ...
    private static void my_Test3(AnnotationConfigApplicationContext context) throws Exception {
    ...
    private static void my_Test4(AnnotationConfigApplicationContext context) throws Exception {
