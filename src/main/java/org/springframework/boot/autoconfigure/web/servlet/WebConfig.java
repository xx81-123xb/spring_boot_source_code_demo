...
//        handler.setLocations(ListUtil.of(new ClassPathResource("static/")));
        handler.setLocations(ListUtil.of(new FileSystemResource(System.getProperty("user.dir")+"/tomcat/static/")));
        //典型责任链模式
        handler.setResourceResolvers(ListUtil.of(
                new CachingResourceResolver(new ConcurrentMapCache("cache1")),//读取资源缓存
                new EncodedResourceResolver(),//读取磁盘压缩资源
                new PathResourceResolver()//读取磁盘未压缩资源
        ));
        return handler;
    }
    ...
    public ResourceHttpRequestHandler handler2() {
        ResourceHttpRequestHandler handler = new ResourceHttpRequestHandler();
        handler.setLocations(ListUtil.of(new ClassPathResource("images/")));
        return handler;
    }
